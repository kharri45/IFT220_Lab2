...
New-ADOrganizationalUnit -Name ST_Computers -Path "DC=ad,DC=sparky-tech,DC=lan" -Description "ST Computers"
 ...
 New-ADOrganizationalUnit -Name Servers -Path "OU=ST_Computers,DC=ad,DC=sparky-tech,DC=lan"
...
New-ADOrganizationalUnit -Name ST_Groups -Path "DC=ad,DC=sparky-tech,DC=lan" -Description "High Level Security Groups"
...
New-ADGroup -GroupCategory Security -GroupScope Global -Name Leadership -Path "OU=KH_Groups,DC=ad,DC=sparky-tech,DC=com"
